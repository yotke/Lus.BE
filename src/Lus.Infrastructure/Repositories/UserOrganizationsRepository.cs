...
{
    public class UserOrganizationsRepository : EntityFrameworkRepository<UserOrganization, int>, IUserOrganizationsRepository
    {
        public UserOrganizationsRepository(ApplicationContext context, IChangeApplierService changeApplier,
