...
{
    public class SmsNotificationsRepository : EntityFrameworkRepository<SmsNotification, int>, ISmsNotificationsRepository
    {
        public SmsNotificationsRepository(ApplicationContext context, IChangeApplierService changeApplier,
